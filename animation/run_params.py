...
class RunParams():
    def __init__(self, output_path, batch_name, init_image, prompts, **kwargs):
        ...
        self.use_init = True 
        self.strength = 1 
        self.strength_0_no_init = True # Set the strength to 0 automatically when no init image is used
        self.init_image = init_image  
        # Whiter areas of the mask are areas that change more
        self.use_mask = False 
        self.use_alpha_as_mask = False # use the alpha channel of the init image as the mask

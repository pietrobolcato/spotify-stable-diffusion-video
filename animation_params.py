...
class AnimationParams():
    ...
    def _get_animation_args(self, **kwargs):
        ...
        strength_schedule = "0: (0.9) 20: (0.8) 30: (0.5) 34: (0.4) 36: (0.3) 38: (0.75)"
    ...
    def _get_inbetweens(self, key_frames, max_frames, integer=False, interp_method='Linear'):
    ...
    def __str__(self):
      summary = f"translation_z: {self.anim_args['translation_z']}\n" + \
